...
VENVPATH="$PROJPATH/filmroll-dev-env"
MAKEPATH="$PROJPATH/filmroll-dev-build"
DISTPATH="$PROJPATH/filmroll-dev-dist"
APPLPATH="$PROJPATH/filmroll-dev-app"
...
VERSION=$(python3 -c "from core.config import Config; cfg=Config(); print(cfg.version)")
